    ...
    >
      <div class="max-w-lg">
        ...
        <p class="mt-3 text-lg leading-6 ">
          If you'd like to get in touch, you can simply fill out this form or
          directly email me at the email below. A message on LinkedIn or Github
          works as well!
        </p>
        <dl class="mt-8 text-base ">
          ...
          <div class="mt-3">
            ...
            <dd class="flex">
              ...
              <span class="ml-3">
                <a target="_top" href="mailto:evan@evanflynn.com"
      ...
      >
          ...
          <div class="mt-3 text-center sm:mt-5">
            ...
            <div class="mt-2">
              <p class="text-sm text-gray-500">
                I've got your information and will respond to you as soon as I
        ...
        <div class="mt-5 sm:mt-6">
          <button
            ...
            type="button"
            class="inline-flex justify-center w-full rounded-md border border-transparent shadow-sm px-4 py-2 bg-primary text-base font-medium text-white hover:bg-theme-dark-blue focus:outline-none"
          >
            Close
          </button>
        </div>
